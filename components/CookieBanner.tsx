...
export default function CookieBanner() {
  ...
  return (
    <>
      {/* Floating cookie button — always visible after first consent */}
      {hasStored && !visible && (
        <button
          onClick={openSettings}
          className="fixed bottom-5 left-5 z-[997] w-9 h-9 rounded-full bg-white border border-gray-200 shadow-md flex items-center justify-center hover:shadow-lg hover:scale-110 transition-all"
