      ...
      <div ref={panelRef} className="fixed left-0 top-1/2 -translate-y-1/2 z-[9999] flex flex-col items-start gap-1">
        ...
        {open && (
          <div
            ...
            className="absolute left-[46px] top-1/2 -translate-y-1/2 w-[280px] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden"
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3" style={{ backgroundColor: accentColor }}>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="text-white/60 hover:text-white transition-colors leading-none text-base"
            ...
            <div className="overflow-y-auto p-4 space-y-5" style={{ maxHeight: 'calc(88vh - 96px)' }}>

              {/* Schriftgröße */}
              <Section title="Schriftgröße">
                <div className="flex gap-2">
                  {([
                    { label: 'A', fs: 14, val: 0 as FontSize },
                    { label: 'A', fs: 17, val: 1 as FontSize },
                    { label: 'A', fs: 21, val: 2 as FontSize },
                  ]).map(({ label, fs, val }) => (
                    <button
                      key={val}
...
function Toggle({
  label, sub, active, onChange, accentColor,
}: {
  ...
  return (
    <button
      ...
      style={{
        borderColor: active ? accentColor : '#f3f4f6',
        backgroundColor: active ? accentColor + '12' : '#fafafa',
      }}
    >
      <div className="flex-1 min-w-0 mr-3">
        <div className="text-[13px] font-semibold leading-tight" style={{ color: active ? accentColor : '#374151' }}>
          {label}
        </div>
