...
export default function WcagScanner() {
  ...
  const handleScan = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok || data.error) {
        ...
        if (score < 90) setShowContact(true)
      }
    } catch {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#112080] via-[#1e3ab8] to-[#2a50cc]">
      ...
      <div className="px-6 pb-20 pt-8 max-w-3xl mx-auto">
          ...
          <div className="space-y-5 animate-fade-in">
            ...
            {showContact && (
              <div className="bg-[#ff8a00]/10 border border-[#ff8a00]/30 rounded-2xl p-6 text-center">
                <p className="text-[#ff8a00] font-bold text-lg mb-2">
                  Wir beheben das für Sie.
                </p>
